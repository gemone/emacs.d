...
[[ -e `which npm` ]] && npm install --global --prefix ./etc/npm --registry=https://mirrors.huaweicloud.com/repository/npm/ bash-language-server

[[ -e `which npm` ]] && npm install --global --prefix ./etc/npm --registry=https://mirrors.huaweicloud.com/repository/npm/ typescript-language-server typescript eslint
...
[[ -e `which npm` ]] && npm install --global --prefix ./etc/npm --registry=https://mirrors.huaweicloud.com/repository/npm/ vscode-langservers-extracted
